...
console.log('어레이에 마지막 아이템 “Zebra” 제거하기');
animals.pop();
console.log(animals);
console.log('');

console.log('주어진 어레이에 “Dog” 추가하기');
animals.push('Dog');
console.log(animals);
console.log('');

console.log('주어진 어레이에 “Mosquito”,“Mouse”,“Mule” 추가하기');
animals.push('Mosquito', 'Mouse', 'Mule');
console.log(animals);
console.log('');

console.log('해당 어레이에는 "Human"이 있는가?');
console.log(animals.includes('Human'));
console.log('');

console.log('해당 어레이에는 "Cat"이 있는가?');
console.log(animals.includes('Cat'));
console.log('');

console.log('"Red deer"을 "Deer"로 바꾸시오');
console.log(animals.indexOf('Red deer'));
animals[animals.indexOf('Red deer')] = 'Deer';
console.log(animals);
console.log('');

console.log('"Spider"부터 3개의 아이템을 기존 어레이에서 제거하시오');
console.log(animals.indexOf('Spider'));
animals.splice(animals.indexOf('Spider'), 3);
console.log(animals);
console.log('');

console.log('"Tiger"이후의 값을 제거하시오');
console.log(animals.indexOf('Tiger'));
animals.splice(animals.indexOf('Tiger'));
console.log(animals);
console.log('');

console.log('"B"로 시작되는 아이템인 "Baboon"부터 "Bison"까지 가져와 새로운 어레이에 저장하시오');
